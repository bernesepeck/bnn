...
db513aee-cd3a-47a9-95e5-a98f1cc92d13	Admin	User	gannonline90@gmail.com	$argon2id$v=19$m=65536,t=3,p=4$8mOx4/9GjUaVmWJRCxhc1Q$O2PmAQbgGlqxaNAnsgyyJRQxPl+9HeBKZ5z7JMZjqbo	\N	\N	\N	\N	\N	\N	\N	active	878f0264-16f3-4a54-a79e-82c27313bacc	\N	2024-02-16 10:36:40.42+00	/content/EmailForm	default	\N	\N	t	\N	\N	\N	\N	\N
\.
...
SELECT pg_catalog.setval('public."GeneralTranslations_translations_id_seq"', 18, true);
...
SELECT pg_catalog.setval('public.directus_activity_id_seq', 889, true);
...
SELECT pg_catalog.setval('public.directus_revisions_id_seq', 782, true);
